...
dojo.config(["$stateProvider", "$urlRouterProvider", function ($stateProvider, $urlRouterProvider) {
...
dojo.controller('loadCtrl', ["$scope", "$state", "$timeout", "getLesson", function($scope, $state, $timeout, getLesson) {
...
dojo.controller('playerCtrl', ["$scope", "$timeout", "$stateParams", "$state", "$http", "player", "userInput", "speechRec", "gradingService", function($scope, $timeout, $stateParams, $state, $http, player, userInput, speechRec, gradingService) {
// Get Lesson Data
...
dojo.service('getLesson', ["$http", "$q", function($http, $q){
