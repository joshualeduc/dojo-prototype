...
//    Grading
  ...
  $scope.slideSettings = function (){
    if($scope.currentSlide.compT){
      ...
      $scope.slideObj.question = $scope.slideObj.phrase + ' ' + $scope.slideObj.userName;
      $scope.slideObj.answer = $scope.slideObj.answerKey + ' ' + $scope.slideObj.userName;
      $scope.slideObj.gradeFunc = $scope.gradeProd;
      $scope.slideObj.submitButton = true;
      $scope.slideObj.phrase = $scope.slideObj.question;
      $scope.slideObj.answerKey = $scope.slideObj.answer;
